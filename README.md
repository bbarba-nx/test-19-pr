...
[Click here to finish setting up your workspace!](https://staging.nx.app/connect/6nRKRvpWlr)
...
```sh
npx nx serve test-19-pr
```

To create a production bundle:

```sh
npx nx build test-19-pr
```

To see all available targets to run for a project, run:

```sh
npx nx show project test-19-pr
```
